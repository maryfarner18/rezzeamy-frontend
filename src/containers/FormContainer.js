    ...
    switch (this.props.step) {
      ...
      case 2:
        return (
          <FormPart
            formType="addresses"
            info={addresses[addresses.length - 1]}
      ...
      case 3:
        return (
          <FormPart
            formType="educations"
            info={educations[educations.length - 1]}
            labels={LABELS.educations}
            nextStep={this.nextStep}
            prevStep={this.prevStep}
            handleChange={this.handleChange}
            handleFileChange={this.handleFileChange}
      ...
      case 4:
        return (
          <FormPart
            formType="work_experiences"
            info={work_experiences[work_experiences.length - 1]}
            labels={LABELS.work_experiences}
            nextStep={this.nextStep}
            prevStep={this.prevStep}
            handleChange={this.handleChange}
            handleFileChange={this.handleFileChange}
      ...
      case 7:
        return (
          <FormPart
            formType="websites"
            info={websites[websites.length - 1]}
            labels={LABELS.websites}
            nextStep={this.nextStep}
            prevStep={this.prevStep}
            handleChange={this.handleChange}
            handleFileChange={this.handleFileChange}
      ...
      case 8:
        ...
        return (
          <SuccessForm
            currentUserSlug={this.props.currentUser.user.user_slug}
          />
        );
  ...
  render() {
    return (
      ...
      <div>
        ...
        <Segment attached>{this.renderForm()}</Segment>
      </div>
