...
export default class EditForm extends Component {
  ...
  handleWorkChange = (e, workExperience) => {
    let prevWorkExperience = this.state.work_experiences.find(
  ...
  handleEduChange = (e, edu) => {
    let prevEdu = this.state.educations.find(
      education => education.id === edu.id,
    );
            ...
            <React.Fragment key={exp.id}>
              <Form.Group widths="equal" style={{ margin: 10 }}>
                <Form.Input
                  ...
                  name="company"
                  value={exp.company}
                  onChange={event => this.handleWorkChange(event, exp)}
                />
                <Form.Input
                  fluid
                  label="Title"
            ...
            <React.Fragment key={skill.id}>
              <Form.Group widths="equal" style={{ margin: 10 }}>
                <Form.Input
                  ...
                  name="name"
                  value={skill.name}
                  onChange={event => this.handleSkillChange(event, skill)}
                />
                <Form.Input
                  fluid
                  label="Proficiency"
            ...
            <React.Fragment key={edu.id}>
              <Form.Group widths="equal" style={{ margin: 10 }}>
                <Form.Input
                  ...
                  onChange={event => this.handleEduChange(event, edu)}
                />
                <Form.Input
                  fluid
                  label="Degree"
            ...
            <React.Fragment key={project.id}>
              <Form.Group widths="equal" style={{ margin: 10 }}>
                <Form.Input
                  ...
                  name="title"
                  value={project.title}
                  onChange={event => this.handleProjectChange(event, project)}
                />
                <Form.Input
                  fluid
                  label="Description"
            ...
            <React.Fragment key={website.id}>
              <Form.Group widths="equal" style={{ margin: 10 }}>
                <Form.Input
                  ...
                  name="link"
                  value={website.link}
                  onChange={event => this.handleWebsiteChange(event, website)}
                />
              </Form.Group>
            </React.Fragment>
          );
